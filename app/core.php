...
class Core {
	...
	private function registerRoutes() {
		...
		#paths will be autogenerated from db and included accordingly
		#restrictions will be placed on access to them
		#need to create a permission matrix
		$klein->respond('GET', '/home', function ($request, $response, $service) {
			$service->render($this->config['path']['view'].'/home/home.html');
		});
		$klein->dispatch();
	}
